...
온책읽기는 초등학교 정규 교육 과정으로, 책을 읽고 여러 참여형 활동을 함께 하며 책 내용을 더 깊게 이해하도록 돕는 수업입니다.하지만 온책읽기 활동을 준비하고 정리하는 과정이 번거롭습니다.</br>
온책읽기를 학교 모바일 기기를 활용하여 수업에 활용할 수 있도록 메타버스 플랫폼을 구현했습니다. AI기술을 활용하여 선생님은 간단하게 수업을 준비하고 활동 결과를 확인할 수 있습니다. 학생은 자신이 그린 아바타로 창의적이고 몰입감있는 활동을 할 수 있습니다.
...
- 회원 관리
- 선생님 온책읽기 자료 관리, 학생 수업 결과 조회 기능 구현
...
### 🧱 5-2. 아키텍처 [상세 WIKI](https://github.com/MTVS3rd-MariMo/Marimo-BE/wiki/Architecture)

### 🗺️ 5-3. Context Map [상세 WIKI](https://github.com/MTVS3rd-MariMo/Marimo-BE/wiki/Context)
...
- 이름, 비밀번호로 로그인한다.
### 📚 6-2. 온책읽기 자료 제작, 수정, 삭제
- 선생님이 책 제목, 저자, `pdf`를 등록하면 `pdf`를 AI서버로 전송한다. 내용을 기반으로 AI가 열린 질문 2개, 퀴즈 8개, 등장인물 4명, 단체사진 배경 1개를 생성한다.
  - 선생님은 생성된 온책읽기 자료를 확인하고 열린 질문 2개, 퀴즈 2개를 선택하고 수정한 뒤, 저장한다.
  - 수정한 수업자료를 저장하면 백그라운드에서 배경 이미지를 생성한다.
- 선생님은 기존에 생성한 온책읽기 자료를 수정, 삭제할 수 있다.
### 🏫 6-3. 수업 생성
- 저장된 온책읽기 자료를 이용해서 온책읽기 월드를 생성한다.
### 👩‍🎨 6-4. 아바타 생성
